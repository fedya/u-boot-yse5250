...
#endif
//David yeo add at 2013.03.25
#define GPX1CON		*(volatile unsigned long *)(0x11400C20)
#define GPX1DAT		*(volatile unsigned long *)(0x11400C24)
#define GPX1PUD		*(volatile unsigned long *)(0x11400C28)

#define DEBUG_LED_OFF		GPX1DAT |= (0x1 << 1)
#define DEBUG_LED_ON		GPX1DAT &= ~(0x1 << 1)

#define DEBUG_LED_SET		GPX1CON = (GPX1CON & ~(0xF << 4)) | (0x1 << 4)
//==========================================================
