...
//#define EPLL_CON1_REG		__REG(ELFIN_CLOCK_BASE+EPLL_CON1_OFFSET)
#define VPLL_CON0_REG		__REG(ELFIN_CLOCK_BASE+VPLL_CON0_OFFSET)
//#define VPLL_CON1_REG		__REG(ELFIN_CLOCK_BASE+VPLL_CON1_OFFSET)
//#define BPLL_CON0_REG		__REG(ELFIN_CLOCK_BASE+BPLL_CON0_OFFSET)
//#define BPLL_CON1_REG		__REG(ELFIN_CLOCK_BASE+BPLL_CON1_OFFSET)
