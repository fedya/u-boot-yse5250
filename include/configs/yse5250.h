...
#define CONFIG_MACH_YSE5250            1       /* which is in a YSE5250 */
#define CONFIG_CPU_EXYNOS5250_EVT1      1       /* which is in a Exynos5250 EVT1 */
#define CONFIG_EXYNOS5_SCP				1
...
/* APLL : 1.6GHz */
//#define CONFIG_CLK_ARM_1600_APLL_1600
/* APLL : 1.7GHz */
//#define CONFIG_CLK_ARM_1700_APLL_1700
/* LPDDR support */
#define CONFIG_DDR3
...
#define CONFIG_PM_VDD_LDO21	1500			//1250
/* For SCP TYPE */
...
#define CONFIG_SCP_PM_VDD_LDO21	1250
#else
#define CONFIG_SCP_PM_VDD_ARM	1250		//1200
#define CONFIG_SCP_PM_VDD_INT	1150		//1000
#define CONFIG_SCP_PM_VDD_G3D	1000		//1200
#define CONFIG_SCP_PM_VDD_MIF	1000		//1100
#define CONFIG_SCP_PM_VDD_LDO21	1500		//1350
#endif	//CONFIG_LPDDR3
#else
...
#define CONFIG_BOOTCOMMAND2 \
	...
	"movi r u 0 42000000;emmc open 1;movi w z u 1 42000000;emmc close 1;"	\
	"movi r t 0 42100000;emmc open 1;movi w z t 1 42100000;emmc close 1;"	\
	"fdisk -c 1 654 5800 528"
...
/* eMMC Bootloader Recovery */
#define CONFIG_EMMCRECOVERY	\
							"mmc erase boot 1 0 0;" \
							"emmc open 1;" \
							"movi read fwbl1 0 40000000;movi write zero fwbl1 1 40000000;" \
							"movi read bl2 0 40004000;movi write zero bl2 1 40004000;" \
							"movi read u-boot 0 42000000;movi write zero u-boot 1 42000000;" \
							"movi read tzsw 0 42100000;movi write zero tzsw 1 42100000;" \
							"emmc close 1"
...
#define CONFIG_IDENT_STRING		" for YICSYSTEM YSE5250-scp"
...
#define MACH_TYPE				4125	/* YSE5250 Machine ID */
